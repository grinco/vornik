...
func (m *mockTaskLLMUsageRepository) AggregateByAPIKey(ctx context.Context, since, until time.Time, limit int, projectID string) ([]persistence.APIKeySpend, error) {
	return nil, nil
}
