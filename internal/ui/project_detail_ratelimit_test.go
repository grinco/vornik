...
func (s *stubAPIKeyRepo) GetByID(_ context.Context, _ string) (*persistence.APIKey, error) {
...
func (*stubAPIKeyRepo) ListAttributable(context.Context) ([]*persistence.APIKey, error) {
	return nil, nil
}
